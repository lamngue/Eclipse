 ...
 **********************************************************************/
	...
	through 3 deeper recursive calls. So the total additional steps that method 
	has to go through is 3^N (N is string length), so the time it takes grows. 
/**********************************************************************
 ...
 **********************************************************************/
// 
	We consider running the dynamic method not the recursive method since it
	cannot handle big N values. 
	...
	EditDistance is: 
	t = (2*10^-8) * N^2 (seconds) (where a = 0.2/3000^2 as in the table)
